prizesObject = [
  {
    ...
    "prizes": [
      ...
      "Hackster: Goodie Bag: Microcontroller, T-shirt, Stickers",
      "Mentorship from NFL"
    ],
    "url": ""
  },
  {
    ...
    "prizes": [
      ...
      "Emotive Headset",
      "Roblox Swag bag: ROBLOX Swag Bag: Beanie, Water Bottle, T-Shirt",
  ...
  },
  {
    ...
    "prizes": [
      ...
      "Particle Boards",
      "Muse Headset",
      "Galvanize: Free desk space, diversity scholarship prize",
      "HTC Phone",
      "Draper: Teams 3 & 2 receive $3,500 off tuition(per applicant accepted)",
      "Mentorship from NFL",
    ],
  ...
  },
  {
    ...
    "prizes": [
      ...
      "1 Year free Chegg Study (Textbook Solutions)",
      "4 hours of tutoring with Chegg Tutors for each team member"
    ],
    "url": ""
  },
  {
